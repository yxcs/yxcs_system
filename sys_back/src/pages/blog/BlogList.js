...
class BlogList extends Component {
  ...
  getDrafList = () => {
    ...
    http.getArticles({draft: false}, pager.size, pager.page).then(res => {
  ...
  onUnPublishDraft = (id) => {
    http.updateArticle({id, params: {draft: true}}).then(res => {
        ...
        render: (id, record, index) => {
          return (
            <div>
              ...
              <Button size="small" onClick={this.onUnPublishDraft.bind(this, id)}>撤销</Button>
              <span className="btn-pad"></span>
